...
static const uint256 hashGenesisBlock("0x0000029b6cd30629e16e0d7df8ee31fb3df438232758c7c813eb357ab0712f91");
static const uint256 hashGenesisBlockTestNet("0x0000029b6cd30629e16e0d7df8ee31fb3df438232758c7c813eb357ab0712f91");
...
public:
    ...
    {
        // Plankton: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Plankton: get transaction coin age
...
public:
    ...
    // Plankton: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Plankton: two types of block: proof-of-work or proof-of-stake
    ...
    // Plankton: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Plankton: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Plankton: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Plankton: block index flags
    enum  
    {
